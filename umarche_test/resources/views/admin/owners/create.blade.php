                    ...
                    <div class="container px-5 py-12 mx-auto">
                        ...
                        <div class="flex flex-wrap -m-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="name" name="name" required class="w-full bg-blue-100 bg-opacity-50 rounded border border-blue-300 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-200 text-base outline-none text-blue-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            </div>
                            </div>
                            <div class="p-2 w-full">
                            <div class="relative">
                                <label for="email" class="leading-7 text-sm text-blue-600">メールアドレス</label>
                                <input type="email" id="email" name="email" required class="w-full bg-blue-100 bg-opacity-50 rounded border border-blue-300 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-200 text-base outline-none text-blue-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            </div>
                            </div>
                            <div class="p-2 w-full">
                            <div class="relative">
                            ...
                            <button onclick="location.href='{{ route('admin.owners.index') }}'" class="mr-8 text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded text-lg">戻る</button>
