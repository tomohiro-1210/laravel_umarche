            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <section class="text-blue-600 body-font relative">
                    <div class="container px-5 py-12 mx-auto">
                        ...
                        <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">オーナー情報編集画面</h1>
                        </div>
                            ...
                            <form method="POST" action="{{ route('admin.owners.update' , ['owner' => $owner->id]) }}">
                                ...
                                <div class="flex flex-wrap -m-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" id="name" name="name" value="{{ $owner->name }}" required class="w-full bg-blue-100 bg-opacity-50 rounded border border-blue-300 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-200 text-base outline-none text-blue-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                    </div>
                                    </div>
                                    <div class="p-2 w-full">
                                    <div class="relative">
